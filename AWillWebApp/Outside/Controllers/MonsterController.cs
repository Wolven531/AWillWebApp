...
namespace AWillWebApp.Controllers
{
	...
	public class MonsterController : ControllerBase
	{
		...
		public MonsterController(IMonsterRepository monsterRepository, ILogger<MonsterController> logger)
		{
		...
		public async Task<IEnumerable<Monster>> GetAllMonstersAsync([FromQuery] bool withImages = false)
		{
			...
			var monsters = await _MonsterRepository.GetMonsters(withImages);
